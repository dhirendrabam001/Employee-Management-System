      ...
      <div className="container">
        <div className="attendance-header d-flex flex-column flex-md-row align-items-center justify-content-between gap-3 mb-4">
          ...
          <div className="attendance-clock-btn">
            <button type="button" className="btn btn-clock-in d-flex align-items-center gap-3">
              <span className="btn-clock-icon">
                <FaArrowRightLong />
              </span>
              <span className="btn-clock-copy">
                <span className="btn-clock-title">Clock In</span>
                <span className="btn-clock-subtitle">start your work day</span>
              </span>
            </button>
          </div>
        </div>
        ...
        <div className="attendance-table-card mt-4 p-4">
          <div className="d-flex flex-column flex-md-row align-items-start align-items-md-center justify-content-between gap-3 mb-4">
            <div>
              ...
              <p className="mb-0 text-muted">A quick view of your latest check-ins and work hours.</p>
            </div>
            <div className="badge bg-light text-dark py-2 px-3">Avg. Work Hrs 8.5</div>
          </div>
